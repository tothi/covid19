...
def makeplot(df, dmax, trange, c, ylim=False):
    ...
    ax.set(title = 'Impact of Epidemiological Measures (COVID-19 {})\n(early stage SIR exponential model)'.format(c))
    ax.set(xlabel = 'days passed since outbreak / first registered case')
...
if __name__ == "__main__":
    ...
    p = makeplot(df, dmax=30, trange=range(6, 22, 5), c="Hungary")
